...
// Exemplificare:
//  Se da un tablou bidimensional de dimensiune n xm, reprezentand suprafata unei camere.
// Camera poate sa contina obstacole, reprezentate in matrice printr-o valoare de 1.
// Celulele cu valoarea 0 reprezinta suprafetele libere ale camerei.
//  Dandu-se un punct interior source(x, y), sa se decida care este cel mai scurt drum
// pana la o ieşire, folosind doar deplasari verticale si/sau orizontale. 
// Iesirile pot sa fie doar pe marginea tabloului, si sunt simbolizate prin cifra 2.
